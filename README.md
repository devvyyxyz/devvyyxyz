...
┌──(devvyyxyz@github)-[~]
└─$ uname -a
HumanOS x86_64 /dev/creativity shell=bash
...
┌──(devvyyxyz@github)-[~]
└─$ cat certs.badges
CERTS       : Security+ (in-progress)
BADGES      : TryHackMe, Hack The Box (active)

┌──(devvyyxyz@github)-[~]
└─$ cat profile.txt
────────────────────────────────────────────────────────────────────────────
USER        : Devvyyxyz (Kai)
ROLE        : Software & Cyber Security Developer
WEBSITE     : https://devvyy.xyz
BLOG        : https://blog.devvyy.xyz
────────────────────────────────────────────────────────────────────────────

┌──(devvyyxyz@github)-[~]
└─$ cat session.status
WORKING_ON  : Developer tools, creative utilities
LEARNING    : Advanced JavaScript, UI architecture
FOCUS       : Modular, readable, reusable systems
UPTIME      : ∞

┌──(devvyyxyz@github)-[~]
└─$ ls commands/
help        projects     github      website
blog        contact      stats

┌──(devvyyxyz@github)-[~]
└─$ ./commands/contact
$ mail devvyyxyz@gmail.com
...
┌──(devvyyxyz@github)-[~]
└─$ uptime
System uptime and session statistics
────────────────────────────────────────────────────────────────────────────
LOAD_AVG    : █████████████░░░░░░ (high activity)
RUNTIME     : ∞ hours (perpetual)
STATUS      : ● ONLINE
────────────────────────────────────────────────────────────────────────────
```
